...
export const Homepage = () => {
  ...
  useEffect(() => {
    ...
    const targetScopePosition = () => {
      ...
      const rectForWrapperPosition = wrapperRef.current.getBoundingClientRect();
      ...
      const scopeDimensions = {
        width: rectForWrapperPosition.width,
        height: rectForWrapperPosition.height,
      };

      const x =
        rectForTargetPosition.left -
        rectForWrapperPosition.left -
        scopeDimensions.width / 2;

      const y =
        rectForTargetPosition.top -
        rectForWrapperPosition.top -
  ...
  return (
    <div ref={scope}>
      ...
      >
        <div className="w-full py-4 relative z-20 max-w-lg mx-auto px-5">
          <Image
            width={128}
            height={128}
            src="/logo.png"
        ...
        <div className="grid fixed inset-0 border-x border-[rgba(187,_192,_223,_0.06)] place-items-center min-h-[100dvh] max-w-lg text-center mx-auto">
          <div
            aria-hidden
            className="absolute z-[1000] bottom-0 origin-bottom-right right-0 pointer-events-none h-32 w-32 md:h-48 md:w-48 -translate-y-2 md:translate-y-0 scale-[0.2]"
            ref={divRef}
          ></div>
          <div
            ref={wrapperRef}
                  ...
                  <motion.div>
                    ...
                    >
                      <motion.img
                        ...
                        className={`h-32 w-32 [-webkit-user-drag:none] select-none md:h-48 md:w-48 object-center object-cover`}
                      />
                    </motion.button>
                    <motion.h2
                      id="name"
              ...
              return (
                ...
                >
                  <motion.img
                    ...
                    className={`w-20 h-20 [-webkit-user-drag:none] select-none md:w-28 md:h-28 ${item.className} object-center object-cover`}
                  />
                  <motion.h2
                    transition={{
                      layout: {
